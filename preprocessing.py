...
class CTPreprocess:
    ...
    def __init__(self, source_directory, savepath, input_ext="nii", output_ext="png",
        ...
        self.in_ext = input_ext
        self.out_ext = output_ext
        self.data_methods = {
        ...
        self.datafiles = glob.glob(join(self.src, "**/*", self.in_ext),
                                                recursive=True)
        self.normit = normalize

        self.img_id = None

        # special case for totalsegmentator
        self.read_with_sitk = ["S0864/ct.nii.gz"]
    ...
    def GenerateDataset(self):
        ...
        if not os.path.isdir(parentdir):
            os.makedirs(parentdir)
        self.data_methods.get(self.out_ext, lambda: "Invalid output dataset.")()
